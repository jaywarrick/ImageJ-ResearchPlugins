...
//	}
	...
	public static String saveImage(ImagePlus im)
	{
		...
		String fullPath = JEXWriter.getTempFolder() + File.separator + JEXWriter.getUniqueRelativeTempPath("tif");
	...
	{
		String fullPath = JEXWriter.getTempFolder() + File.separator + JEXWriter.getUniqueRelativeTempPath(extension);
	...
	public static boolean copy(File src, File dst, boolean forceCopyWithinTempFolder) throws IOException
	{
		...
		boolean srcIsInTempFolder = FileUtility.isFileInDirectory(src, new File(JEXWriter.getTempFolder() + File.separator + JEXWriter.getTempFolderName()));
