...
public class CSVReader extends BufferedReader {
	 ...
	 * 
	 * @return true if last field read was at the end of the line, false otherwise or if no fields have been read.
	 */
	 ...
	 * 
	 * @param fields
	 *            container for the fields in the current row. It will be cleared.
	 * @throws IOException
	 ...
	 * @return next field
	 * @throws IOException
	 *             If an I/O error occurs, may be an EOFException on end of input.
	 */
