 ...
 * </p>
 */
@Plugin(type = Command.class, menuPath = "JEX>OpenScaleSaveImage")
public class OpenScaleSaveImage implements Command {
	...
	public void run() {
		try {
			...
			// save the image
			datasetIOService.save(result, (new File(outputDirectory.getAbsolutePath() + File.separator + outputFileName)).getAbsolutePath());
		}
